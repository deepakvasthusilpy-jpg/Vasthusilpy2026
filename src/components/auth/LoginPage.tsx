          ...
          {loginMode === "subscription" && subMode === "login" && (
            <form onSubmit={handleSubscriptionLogin} className="space-y-5">
              ...
              <button
                ...
                className="w-full mt-2.5 py-3 rounded-full bg-white/15 hover:bg-white/25 active:scale-[0.99] border border-white/30 text-white font-bold text-sm tracking-wide shadow-lg transition-all cursor-pointer flex items-center justify-center gap-3 backdrop-blur-md"
              >
