...
export const KsmartTab: React.FC = () => {
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="bg-slate-900/90 p-6 rounded-2xl border border-slate-800 shadow-xl bg-blueprint-grid text-slate-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="p-3.5 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl text-slate-950 shadow-lg shadow-emerald-500/20">
          ...
          <div>
            ...
            <p className="text-xs text-slate-300 mt-1">
              Track Kerala Building Permit Applications, Occupancy Certificates, NOCs, and LSGD Files in real time.
            </p>
          </div>
        </div>
      ...
      <div className="relative bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden min-h-[620px] flex flex-col">
        ...
        <div className="relative flex-1 bg-slate-950">
          {!iframeLoaded && (
            <div className="absolute inset-0 bg-slate-950/90 flex flex-col items-center justify-center p-6 text-center space-y-4 z-10">
              ...
              >
                <span>Click here if portal does not load in iframe</span>
